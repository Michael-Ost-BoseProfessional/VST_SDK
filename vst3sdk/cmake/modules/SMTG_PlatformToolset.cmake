...
macro(smtg_setup_platform_toolset)
    ...
    elseif(SMTG_WIN)
        if(MINGW)
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wno-multichar")
            set(common_linker_flags "-Wl,--no-undefined")
            set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} ${common_linker_flags}" CACHE STRING "Module Library Linker Flags" FORCE)
            set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${common_linker_flags}" CACHE STRING "Shared Library Linker Flags" FORCE)
        else()
